...
!function(){function a(a){return document.getElementsByClassName(a)}function e(a){return document.getElementById(a)}function t(a){return document.querySelectorAll(a)}var o=a("slideOne"),s=a("slideTwo"),n=a("slideThere"),c=a("hb"),l=a("of"),u=e("button"),i=a("header"),r=a("textBottom"),d=e("next"),f=a("timeline"),p=a("peak"),y=a("text"),h=e("back"),k=e("last"),g=t(".slideFour > p > span"),m=a("textLast"),A=e("backThere"),O=a("grey"),B=O.length,I=a("peakDiv"),v=I.length,P=a("li"),Q=P.length,E=.2,x=g.length,L=new TimelineMax({delay:1});L.from(c,.5,{autoAlpha:0,ease:Back.easeOut.config(1.7),y:-50}),L.from(l,.5,{autoAlpha:0,ease:Back.easeOut.config(1.7),y:-50}),L.from(i,.5,{autoAlpha:0,ease:Quad.easeInOut,x:-100,scale:.05,rotation:-90}),L.from(u,.5,{autoAlpha:0,y:200,ease:Back.easeOut.config(1.7)}),L.addPause(),L.to(u,.5,{autoAlpha:0,delay:.5,ease:Back.easeOut.config(1.7),y:-100,scale:.1},"first"),L.to(i,.5,{autoAlpha:0,ease:Back.easeOut.config(1.7),y:-100,scale:.1}),L.to(o,.5,{autoAlpha:0,ease:Back.easeOut.config(1.7),y:-50,display:"none",scale:.1},"firstBack");for(b=0;b<Q;b+=1)L.from(P[b],E,{autoAlpha:0,delay:.2*E,ease:Back.easeOut.config(1.7),y:100});L.from(r,.5,{autoAlpha:0,ease:Quad.easeInOut,y:100,scale:.1}),L.from(d,.5,{autoAlpha:0,ease:Quad.easeInOut,y:100,scale:.6}),L.addPause(),L.to(s,.5,{autoAlpha:0,ease:Back.easeOut.config(1.7),y:-50,display:"none",scale:.1},"second"),L.from(n,.5,{autoAlpha:0,ease:Back.easeOut.config(1.7),y:-50,display:"block"},"secondBack"),L.from(f,.5,{autoAlpha:0,ease:Back.easeOut.config(1.7),width:0}),L.from(p,.5,{autoAlpha:0,ease:Back.easeOut.config(1.7),width:0});for(b=0;b<v;b+=1)L.from(I[b],E,{autoAlpha:0,delay:.2*E,ease:Back.easeOut.config(1.7),y:-20});for(b=0;b<B;b+=1)L.from(O[b],E,{autoAlpha:0,delay:.2*E,ease:Back.easeOut.config(1.7),y:-20});L.from(y,.5,{autoAlpha:0,ease:Quad.easeInOut,y:100,scale:.1}),L.from(h,.5,{autoAlpha:0,ease:Quad.easeInOut,y:100,scale:.6}),L.from(k,.5,{autoAlpha:0,ease:Quad.easeInOut,y:100,scale:.6}),L.addPause(),L.to(n,.5,{autoAlpha:0,ease:Back.easeOut.config(1.7),y:-50,display:"none",scale:.1},"third");for(var b=0;b<x;b+=1)L.from(g[b],E,{autoAlpha:0,delay:.2*E,ease:Back.easeOut.config(1.7),y:-100,scale:.8});L.from(m,.5,{autoAlpha:0,ease:Quad.easeInOut,y:100,scale:.1}),L.from(A,.5,{autoAlpha:0,ease:Quad.easeInOut,y:100,scale:.6}),u.addEventListener("click",function(a){a.stopPropagation(),L.play("first")}),d.addEventListener("click",function(a){a.stopPropagation(),L.play("second")}),h.addEventListener("click",function(a){a.stopPropagation(),L.play("firstBack")}),k.addEventListener("click",function(a){a.stopPropagation(),L.play("third")}),A.addEventListener("click",function(a){a.stopPropagation(),L.play("secondBack")})}();